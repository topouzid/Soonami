        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if (responseCode == 200) {
                    ...
                    Log.v("makeHttpRequest", "error response code: " + responseCode);
                    return jsonResponse;
                }
            } catch (IOException e) {
...
//                JSONObject status = metadata.getJSONObject("status");
                    int responseCode = metadata.getInt("status");
                    ...
                    if (responseCode == 200) {
                        ...
                        Log.v("MainActivity", "Error in request");
                    }
                ...
                return null;
//                return new Event("No connection!", 0, 0);
            }
        }
    }
}
